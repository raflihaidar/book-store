        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                <div class="px-6 sm:px-8 py-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-8">Edit Book Details</h2>
                    ...
                    <form action="{{ route('books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                @if ($book->image)
                                    <div class="mt-4">
                                        ...
                                        <img
                                            ...
                                            alt="Current Image"
                                            class="h-48 w-auto rounded-lg shadow-md object-cover"
                                        >
                                    </div>
                                @endif
                        ...
                        <div class="mt-8 flex flex-col sm:flex-row gap-4">
                            <button
                                type="submit"
                                class="flex-1 bg-yellow-600 text-white px-6 py-3 rounded-lg hover:bg-yellow-700 transition-colors duration-200 font-semibold"
                            >
                                ✓ Save Changes
                            </button>
                            <a
